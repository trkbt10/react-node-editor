...
export const jaMessages: I18nMessages = {
  ...
  inspectorNodeLibrary: "ノードライブラリ",
  inspectorNodeLibrarySearchPlaceholder: "ノードを検索…",
  inspectorNodeLibraryEmptyState: "条件に一致するノードはありません",
  inspectorNodeLibraryLimitReached: "上限に達しました",
