...
export const enMessages: I18nMessages = {
  ...
  inspectorInteractionHelpSectionPointer: "Pointer Interactions",
  inspectorInteractionHelpPointerNodeSelect: "Select node",
  inspectorInteractionHelpPointerNodeMultiSelect: "Add node to selection",
  inspectorInteractionHelpPointerRangeSelect: "Range selection drag",
  inspectorInteractionHelpPointerCanvasClearSelection: "Clear selection (click empty canvas)",
  inspectorInteractionHelpPointerCanvasPan: "Pan canvas",
  inspectorInteractionHelpPointerNodeContextMenu: "Node context menu",
  inspectorInteractionHelpPointerCanvasContextMenu: "Canvas context menu",
  inspectorInteractionHelpPointerEmptyTargetSuffix: "(empty target)",
  inspectorInteractionHelpEdit: "Edit",
  inspectorInteractionHelpCancel: "Cancel",
  inspectorInteractionHelpReset: "Reset",
  inspectorInteractionHelpClear: "Clear",
  inspectorInteractionHelpKeyboardPrompt: "Press keys, Esc to cancel",
  inspectorInteractionHelpPointerPrompt: "Click or press, Esc to cancel",
