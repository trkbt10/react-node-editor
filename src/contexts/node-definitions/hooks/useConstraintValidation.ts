...
import type { NodeEditorAction } from "../../composed/node-editor/actions";
 ...
 */
export const useConstraintValidation = (getNodePorts?: (nodeId: NodeId) => Port[]): ConstraintValidationHook => {
