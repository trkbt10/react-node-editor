/**
 * @file Example component showcasing the Adobe Light theme.
 */
...
export const AdobeLightThemeExample: React.FC = () => {
  const [data, setData] = React.useState<NodeEditorData>(() => createInitialData());

  React.useEffect(() => {
    applyTheme("adobe-light");
  }, []);
...
export default AdobeLightThemeExample;
